#!/usr/bin/env python3
"""Publication quotidienne automatisée — site d'affiliation « déguisements d'Halloween ».
...
Usage courant :
    ...
    python publier.py --sujet meilleur-deguisement-halloween
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Publication quotidienne du site déguisements d'Halloween.")
