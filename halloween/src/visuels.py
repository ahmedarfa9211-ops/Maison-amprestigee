...
AMBIANCES = [
    {"fond": "#2A1541", "encre": "#F7EEE2", "accent": "#FF7518"},
    {"fond": "#1B1020", "encre": "#F5E9D8", "accent": "#FF7518"},
    {"fond": "#F7EEE2", "encre": "#2A1541", "accent": "#FF7518"},
    {"fond": "#3A1E12", "encre": "#F7EEE2", "accent": "#F2A93B"},
    {"fond": "#FF7518", "encre": "#1B1020", "accent": "#2A1541"},
    {"fond": "#241033", "encre": "#F7EEE2", "accent": "#7ED957"},
]
...
def accroche(article: dict[str, Any], limite: int = 300) -> str:
    ...
    # (« maquillage fx ») : sur une épingle, ça fait tout de suite bâclé.
    for sigle in ("FX", "DIY", "CE", "LED"):
...
def _rendre_pillow(article: dict[str, Any], config: dict[str, Any]) -> bytes:
    ...
    couleurs = ambiance(article.get("slug") or article.get("id", "halloween"))
    ...
    titre_complet = (article.get("titre_h1") or "Panoplie Halloween").strip()
