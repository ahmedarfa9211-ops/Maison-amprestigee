...
<header class="entete"><div class="conteneur entete-in">
  <a class="logo" href="/"><span class="citrouille" aria-hidden="true">🎃</span> {nom.split(' ')[0]}<span>{' ' + ' '.join(nom.split(' ')[1:]) if ' ' in nom else ''}</span></a>
  <nav aria-label="Navigation principale"><ul class="menu">
    ...
    <li><a href="/categorie/idees/">Idées</a></li>
    <li><a href="/categorie/enfants/">Enfants</a></li>
    <li><a href="/categorie/diy/">Faire soi-même</a></li>
...
<footer class="pied"><div class="conteneur">
  <div class="pied-grille">
    ...
    <div><h4>Catégories</h4><ul>
      <li><a href="/categorie/comparatifs/">Comparatifs</a></li>
      <li><a href="/categorie/guides-achat/">Guides d'achat</a></li>
      <li><a href="/categorie/idees/">Idées &amp; inspiration</a></li>
      <li><a href="/categorie/enfants/">Enfants &amp; famille</a></li>
      <li><a href="/categorie/diy/">Faire soi-même</a></li>
    </ul></div>
